...
import  indoor from "./indoorplant.jpeg";

export default function Indoorplant() {
  const [color, setColor] = useState("Blue");
  const [size, setSize] = useState("Small");
  const [qty, setQty] = useState(1);
  const [mainImage, setMainImage] = useState(indoor);
...
Bring life and elegance to your space with this premium indoor plant, carefully selected for both beauty and ease of care. Thriving in indoor environments, it purifies the air while adding a refreshing touch of greenery to your home or office.

Perfect for living rooms, workspaces, or cozy corners, this plant complements any decor style, from modern minimalist to classic interiors. With healthy foliage and a durable pot, it offers a long-lasting, low-maintenance way to enhance your environment.
        </p>
      </div>
