...
export default function Sneaker() {
  ...
  const [mainImage, setMainImage] = useState(sneaker);
...
Step up your style with these premium sneakers, designed for comfort, performance, and everyday wear. Made with breathable materials and cushioned soles, they keep your feet supported whether you’re walking, running, or just chilling with friends.

Perfect for casual outfits, streetwear, or showcasing your unique style, these sneakers pair effortlessly with jeans, joggers, or shorts. Durable construction and sleek design ensure they stay fresh-looking even after heavy use.
        </p>
      </div>
