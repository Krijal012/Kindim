...
import  walle from "./wallclock.jpeg";

export default function Wallclock() {
  const [color, setColor] = useState("Blue");
  const [size, setSize] = useState("Small");
  const [qty, setQty] = useState(1);
  const [mainImage, setMainImage] = useState(walle);
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-4">
      ...
      This sleek wall clock combines precise timekeeping with modern design, making it a functional and stylish addition to any space. Crafted from high-quality materials, it offers durability and long-lasting performance while maintaining a clean, elegant look.
