...
import flu from "./flutee.jpeg";

export default function Flute() {
  const [color, setColor] = useState("Blue");
  const [size, setSize] = useState("Small");
  const [qty, setQty] = useState(1);
  const [mainImage, setMainImage] = useState(flu);
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-4">
      ...
      <div className="max-w-5xl mx-auto mt-6 bg-gray-200 p-6 rounded-2xl">
        ...
        Elevate your musical performance with this premium flute, crafted for precision, clarity, and ease of play. Made from high-quality materials, it delivers a rich, resonant tone and consistent intonation across all registers, making it ideal for students, hobbyists, and professional musicians alike.

Ergonomically designed for comfort during extended practice or performance, this flute combines durability with elegant craftsmanship. Its sleek finish and responsive keys ensure smooth, expressive playing, making it a versatile and essential instrument for any musician.
        </p>
      </div>
