...
import  ps from "./ps5.jpeg";

export default function Ps5() {
  const [color, setColor] = useState("Blue");
  const [size, setSize] = useState("Small");
  const [qty, setQty] = useState(1);
  const [mainImage, setMainImage] = useState(ps);
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-4">
      ...
      <div className="max-w-5xl mx-auto bg-gray-200 p-6 rounded-2xl shadow">
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="text-lg font-bold mt-2">Rs 90000npr</p>
     ...
     Experience next-level gaming with the PlayStation 5, designed for speed, power, and immersive entertainment. Featuring ultra-high-speed SSD, stunning graphics, and ray-tracing technology, it delivers lifelike visuals and smooth, responsive gameplay for every title.

Engineered with advanced cooling and ergonomic design, the PS5 ensures reliable performance during intense gaming sessions. Compatible with a wide range of games and accessories, it offers seamless connectivity and an unparalleled gaming experience, making it the ultimate centerpiece for any gaming setup.
</p>
      </div>
