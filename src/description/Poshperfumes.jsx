...
import  posh from "./pashperfumes.jpeg";

export default function Poshperfumes() {
  const [color, setColor] = useState("Blue");
  const [size, setSize] = useState("Small");
  const [qty, setQty] = useState(1);
  const [mainImage, setMainImage] = useState(posh);
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-4">
      ...
      <div className="max-w-5xl mx-auto bg-gray-200 p-6 rounded-2xl shadow">
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="text-lg font-bold mt-2">Rs 800npr</p>
     ...
     Discover timeless elegance with Posh Perfumes, crafted to deliver a refined and long-lasting fragrance experience. Blended with premium-quality notes, each scent unfolds beautifully, leaving a sophisticated trail that enhances your confidence throughout the day.

Perfect for everyday wear, special occasions, or gifting, Posh Perfumes combine luxury with versatility. Presented in a sleek, stylish bottle, they add a touch of class to your personal collection and make a statement wherever you go.
</p>
      </div>
