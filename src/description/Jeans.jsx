...
export default function Jeans() {
  ...
  const [mainImage, setMainImage] = useState(jeans);
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-4">
      ...
      <div className="max-w-5xl mx-auto bg-gray-200 p-6 rounded-2xl shadow">
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="text-lg font-bold mt-2">Rs 1800npr</p>
     ...
     These premium denim jeans combine timeless style with exceptional comfort. Crafted from high-quality, durable denim, they provide a perfect fit while maintaining flexibility for all-day wear. Designed with meticulous stitching and attention to detail, they offer both durability and a sleek, modern silhouette.

Ideal for casual outings, professional settings, or weekend adventures, these jeans pair effortlessly with shirts, T-shirts, or layered ensembles, making them a versatile wardrobe essential.
        </p>
      </div>
