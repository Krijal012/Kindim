...
export default function Candle() {
  ...
  const [mainImage, setMainImage] = useState(candle);
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-4">
      ...
      <div className="max-w-5xl mx-auto bg-gray-200 p-6 rounded-2xl shadow">
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="text-lg font-bold mt-2">Rs 950npr</p>
      ...
      <div className="max-w-5xl mx-auto mt-6 bg-gray-200 p-6 rounded-2xl">
       ...
       Light up your space with this elegantly crafted candle, designed to create a warm and soothing ambiance. Made from high-quality wax and infused with a subtle, long-lasting fragrance, it adds a touch of relaxation and charm to any room. Perfect for cozy evenings, meditation, romantic dinners, or as a thoughtful gift, this candle blends style and function effortlessly. Its simple yet sophisticated design complements 
       any decor while filling your surroundings with a gentle, calming glow.
        </p>
      </div>
