...
import  pia from "./piano.jpeg";

export default function Piano() {
  const [color, setColor] = useState("Blue");
  const [size, setSize] = useState("Small");
  const [qty, setQty] = useState(1);
  const [mainImage, setMainImage] = useState(pia);
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-4">
      ...
      <div className="max-w-5xl mx-auto bg-gray-200 p-6 rounded-2xl shadow">
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="text-lg font-bold mt-2">Rs 30000npr</p>
     ...
     Experience unparalleled musical expression with this premium piano, crafted for both elegance and performance. Built with high-quality materials and precision engineering, it delivers rich, resonant tones, responsive keys, and a dynamic range suitable for beginners, enthusiasts, and professional pianists alike.

Designed for durability and smooth playability, this piano combines timeless craftsmanship with modern reliability. Perfect for practice, studio sessions, or live performances, it offers an immersive playing experience while complementing any space with its sophisticated design.
        </p>
      </div>
