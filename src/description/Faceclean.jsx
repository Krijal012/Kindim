...
import face from "./facewash.jpeg";

export default function Faceclean() {
  const [color, setColor] = useState("Blue");
  const [size, setSize] = useState("Small");
  const [qty, setQty] = useState(1);
  const [mainImage, setMainImage] = useState(face);
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-4">
      ...
      <div className="max-w-5xl mx-auto bg-gray-200 p-6 rounded-2xl shadow">
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="text-lg font-bold mt-2">Rs 450npr</p>
      ...
      <div className="max-w-5xl mx-auto mt-6 bg-gray-200 p-6 rounded-2xl">
        ...
        Revitalize your skin with this premium Ubtan Facewash, enriched with natural ingredients and traditional herbal extracts. Gently cleansing while nourishing, it removes impurities, excess oil, and dirt, leaving your skin fresh, radiant, and soft.

Perfect for daily use on all skin types, this facewash helps maintain a healthy glow, balances the skin, and promotes a clear, refreshed complexion. Its soothing formula ensures gentle care while harnessing the natural benefits of Ubtan for a timeless skincare ritual.
        </p>
      </div>
