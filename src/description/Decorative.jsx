...
import deco from "./decorativelight.jpeg";

export default function Decorative() {
  const [color, setColor] = useState("Blue");
  const [size, setSize] = useState("Small");
  const [qty, setQty] = useState(1);
  const [mainImage, setMainImage] = useState(deco);
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-4">
      ...
      Illuminate your space with this premium decorative light, designed to blend style, ambiance, and functionality. Crafted with high-quality materials and a sleek design, it provides a warm, inviting glow that enhances any room, setting the perfect mood for relaxation, entertainment, or special occasions.

Ideal for living rooms, bedrooms, offices, or events, this decorative light combines aesthetic appeal with durability and long-lasting performance. Its elegant design and versatile placement options make it a standout accent piece, effortlessly elevating the ambiance of any space.
        </p>
      </div>
