...
import  smart from "./smartwatch.jpeg";

export default function Smartwatch() {
  const [color, setColor] = useState("Blue");
  const [size, setSize] = useState("Small");
  const [qty, setQty] = useState(1);
  const [mainImage, setMainImage] = useState(smart);
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-4">
      ...
      <div className="max-w-5xl mx-auto bg-gray-200 p-6 rounded-2xl shadow">
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="text-lg font-bold mt-2">Rs 40000npr</p>
     ...
     Stay connected and in control with this premium smartwatch, designed for performance, style, and convenience. Featuring a high-resolution display, intuitive interface, and a range of smart features, it keeps you informed, active, and on schedule throughout your day.

Crafted with durable materials and precision engineering, this smartwatch offers reliable performance, long battery life, and seamless compatibility with your smartphone and favorite apps. Sleek and versatile, it effortlessly complements any outfit or lifestyle, making it an essential accessory for modern living.
</p>
      </div>
