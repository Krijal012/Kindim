...
import  uk from "./ukelele.jpeg";

export default function Ukelele() {
  const [color, setColor] = useState("Blue");
  const [size, setSize] = useState("Small");
  const [qty, setQty] = useState(1);
  const [mainImage, setMainImage] = useState(uk);
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-4">
      ...
      <div className="max-w-5xl mx-auto bg-gray-200 p-6 rounded-2xl shadow">
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="text-lg font-bold mt-2">Rs 3500npr</p>
     ...
     Bring music to life with this premium ukulele, crafted for both beginners and seasoned musicians. Made from high-quality tonewoods and precision-engineered components, it delivers bright, resonant sound and smooth, responsive playability.

Designed for comfort and durability, this ukulele features a sleek finish and well-crafted fretboard, making it ideal for practice, performance, or casual playing. Compact and stylish, it’s perfect for home, travel, or gifting, adding a touch of musical charm wherever you go.
</p>
      </div>
