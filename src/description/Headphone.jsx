...
import  heady from "./headphone.jpeg";

export default function Headphone() {
  const [color, setColor] = useState("Blue");
  const [size, setSize] = useState("Small");
  const [qty, setQty] = useState(1);
  const [mainImage, setMainImage] = useState(heady);
...
Sleek & Immersive Sound: These headphones deliver crystal-clear audio and deep bass, providing an exceptional listening experience for music, calls, and gaming. Comfortable & Durable: Designed with soft ear cushions and a lightweight frame, they offer long-lasting comfort while ensuring durability for everyday use. Versatile & Stylish: Perfect for home, office, travel, or workouts, their modern design complements any style while providing 
reliable wireless or wired connectivity for all your devices.
        </p>
      </div>
