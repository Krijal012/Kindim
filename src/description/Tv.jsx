...
import  tvv from "./tv.jpeg";

export default function Tv() {
  const [color, setColor] = useState("Blue");
  const [size, setSize] = useState("Small");
  const [qty, setQty] = useState(1);
  const [mainImage, setMainImage] = useState(tvv);
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-4">
      ...
      <div className="max-w-5xl mx-auto bg-gray-200 p-6 rounded-2xl shadow">
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="text-lg font-bold mt-2">Rs 45000npr</p>
      ...
      Experience stunning visuals and immersive entertainment with this premium TV, designed for clarity, performance, and modern living spaces. Equipped with high-resolution display technology, vibrant colors, and sharp contrast, it delivers lifelike images and an exceptional viewing experience for movies, sports, and gaming.

Engineered with advanced features and durable construction, this TV ensures reliable performance and seamless connectivity with your favorite devices and streaming platforms. Sleek and stylish, it effortlessly complements any living room or entertainment setup, making it a perfect centerpiece for your home.
</p>
      </div>
