...
export default function Tshirt() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-4">
      ...
      <div className="max-w-5xl mx-auto bg-gray-200 p-6 rounded-2xl shadow">
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="text-lg font-bold mt-2">Rs 700npr</p>
      ...
      Upgrade your everyday look with this Itachi graphic T-shirt, designed for comfort and style. Made from soft, breathable cotton, it feels light on the skin while offering a relaxed and comfortable fit.

Perfect for casual outings, anime meetups, or daily wear, this T-shirt pairs easily with jeans, joggers, or layered streetwear. High-quality print and durable stitching ensure the design stays bold even after long use.
        </p>
      </div>
