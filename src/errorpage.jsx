...
<header className="flex items-center px-10 py-4 bg-[#1A73E8] fixed top-0 left-0 w-full z-[9999] gap-5">
  ...
  {/* Login button */}
  <button className="ml-80 px-6 py-3 text-white border-0 rounded-sm bg-[#0F4EB3] cursor-pointer transition-all duration-500 ease hover:bg-white hover:text-[#0F4EB3]">
    Login
  </button>
</header>
