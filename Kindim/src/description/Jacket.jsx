...
import  jack from "./jacket.jpeg";

export default function Jacket() {
  const [color, setColor] = useState("Blue");
  const [size, setSize] = useState("Small");
  const [qty, setQty] = useState(1);
  const [mainImage, setMainImage] = useState(jack);
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-4">
      ...
      <div className="max-w-5xl mx-auto bg-gray-200 p-6 rounded-2xl shadow">
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="text-lg font-bold mt-2">Rs 3000npr</p>
     ...
     Stay stylish and comfortable with this premium jacket, designed for both fashion and functionality. Crafted from high-quality, durable materials, it offers warmth, protection, and a perfect fit, making it ideal for various weather conditions.

Featuring meticulous stitching and a modern design, this jacket combines durability with effortless style. Perfect for casual outings, outdoor adventures, or daily wear, it pairs seamlessly with any outfit, making it a versatile and essential addition to your wardrobe.
</p>
      </div>
