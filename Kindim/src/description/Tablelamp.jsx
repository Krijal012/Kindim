...
import  table from "./tablelamp.jpeg";

export default function Tablelamp() {
  const [color, setColor] = useState("Blue");
  const [size, setSize] = useState("Small");
  const [qty, setQty] = useState(1);
  const [mainImage, setMainImage] = useState(table);
  ...
  return (
      ...
      <div className="max-w-5xl mx-auto bg-gray-200 p-6 rounded-2xl shadow">
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="text-lg font-bold mt-2">Rs 1200npr</p>
    ...
    Enhance your space with this elegant table lamp, designed to combine style, functionality, and ambient lighting. Crafted with high-quality materials and a sleek design, it provides a warm, inviting glow that brightens any room while adding a touch of sophistication.

Perfect for bedrooms, living rooms, offices, or study areas, this table lamp offers reliable illumination and effortless style. Its durable construction and versatile design make it both a practical and decorative addition, seamlessly complementing any interior décor.
</p>
      </div>
