...
export default function Mamaearth() {
  const [color, setColor] = useState("Blue");
  const [size, setSize] = useState("Small");
  const [qty, setQty] = useState(1);
  const [mainImage, setMainImage] = useState(mama);
  ...
  return (
      ...
      <div className="max-w-5xl mx-auto bg-gray-200 p-6 rounded-2xl shadow">
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="text-lg font-bold mt-2">Rs 600npr</p>
    ...
    Nurture your hair with Mama Earth Shampoo, enriched with natural extracts and gentle ingredients to cleanse, nourish, and strengthen from root to tip. Formulated without harmful chemicals, it promotes healthy, soft, and shiny hair while maintaining the scalp’s natural balance.

Suitable for all hair types, this shampoo helps reduce frizz, adds natural shine, and supports overall hair vitality. Its soothing formula and eco-friendly composition make it a safe, effective, and thoughtful choice for daily hair care.
        </p>
      </div>
