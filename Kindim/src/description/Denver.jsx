...
import den from "./denver.jpeg";

export default function Denver() {
  const [color, setColor] = useState("Blue");
  const [size, setSize] = useState("Small");
  const [qty, setQty] = useState(1);
  const [mainImage, setMainImage] = useState(den);
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-4">
      ...
      <div className="max-w-5xl mx-auto bg-gray-200 p-6 rounded-2xl shadow">
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="text-lg font-bold mt-2">Rs 850npr</p>
      ...
      Make a lasting impression with Denver Perfume, crafted for elegance, sophistication, and long-lasting fragrance. Blending high-quality notes, it delivers a captivating scent that evolves beautifully throughout the day, leaving you refreshed and confident.

Perfect for daily wear, special occasions, or gifting, Denver Perfume combines style and allure effortlessly. Its sleek, modern bottle design adds a touch of luxury, making it a must-have addition to any fragrance collection.
        </p>
      </div>
