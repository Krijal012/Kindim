...
export default function Laptop() {
  ...
  const [mainImage, setMainImage] = useState(lap);
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-4">
      ...
      <div className="max-w-5xl mx-auto bg-gray-200 p-6 rounded-2xl shadow">
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="text-lg font-bold mt-2">Rs 180000npr</p>
     ...
     Experience ultimate performance and productivity with this premium laptop, designed for speed, reliability, and modern lifestyles. Equipped with a high-resolution display, powerful processor, and ample memory, it delivers smooth multitasking, crisp visuals, and fast performance for work, study, or entertainment.

Engineered with durable construction and advanced cooling, this laptop ensures consistent performance during long sessions. Sleek, lightweight, and portable, it seamlessly fits into any workspace or on-the-go setup, making it an essential tool for professionals, students, and creatives alike.
</p>
      </div>
