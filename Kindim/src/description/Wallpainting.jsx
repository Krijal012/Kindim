...
import  wallpaint from "./wallpainting.jpeg";

export default function Wallpainting() {
  const [color, setColor] = useState("Blue");
  const [size, setSize] = useState("Small");
  const [qty, setQty] = useState(1);
  const [mainImage, setMainImage] = useState(wallpaint);
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-4">
      ...
      This sleek wall painting combines artistic elegance with modern design, making it a functional and stylish addition to any space. Crafted from high-quality materials, it offers durability and long-lasting performance while maintaining a clean, elegant look.

Ideal for living rooms, bedrooms, offices, or study areas, its clear display and smooth movement ensure easy readability, while the contemporary design complements a variety of interior styles.
        </p>
      </div>
