...
import brownlotion from "./brownlotion.jpeg";

export default function Facewash() {
  const [color, setColor] = useState("Blue");
  const [size, setSize] = useState("Small");
  const [qty, setQty] = useState(1);
  const [mainImage, setMainImage] = useState(brownlotion);
    ...
    <div className="bg-gray-100 min-h-screen p-4">
      ...
      <div className="max-w-5xl mx-auto mt-6 bg-gray-200 p-6 rounded-2xl">
        ...
        <p className="text-sm text-gray-700">
         Revitalize your hair with WOW Shampoo! Infused with natural extracts and vitamins, it gently cleanses while nourishing your scalp and strands. Say goodbye to dull, lifeless hair and hello to soft, shiny, and healthy locks. Perfect for all hair types, WOW Shampoo strengthens from root to tip, 
         reduces frizz, and gives your hair a smooth, radiant finish every day.
        </p>
      </div>
